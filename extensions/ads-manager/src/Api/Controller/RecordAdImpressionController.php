...
{
    // Same IP re-viewing the same ad within this window is treated as a
    // repeat/bot event and skips the DB increment entirely, so a refresh
    // loop or impression-bot script can't inflate impressions_count.
